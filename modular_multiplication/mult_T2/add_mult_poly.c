...
//~ Computes pa(X)*pb(X) mod(E), with zero poly J = Z.M[E] as parameter
void mult_mod_poly_fixedRandPoly(int64_t *rop, int64_t *pa, int64_t *pb, int64_t *rand_zero){
...
//~ Computes pa(X)^2 mod(E), with zero poly J = Z.M[E] as parameter
void square_mod_poly_fixedRandPoly(int64_t *rop, int64_t *pa, int64_t *rand_zero){
